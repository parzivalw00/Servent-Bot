...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        interaction.reply({
            embeds: [
                embed.setColor('Grey')
                .setDescription(`This channel is now **Locked** for \`${time}\` with reason **${Reason}**.`)
            ]
        })
        ...
        if (Time) {
            ...
            setTimeout(async () => {
                ...
                interaction.reply({
                    embeds: [
                        embed.setColor('Grey')
                        .setDescription(`The **Lockdown** with reason ${Reason} and with length ${time} has been canceled.`)
                    ]
                })
                .catch(() => {})
